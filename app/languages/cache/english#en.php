...
return [
	...
	'global.emails.admin_new_payment_notification.body' => '<strong>{{NAME}}</strong> ({{EMAIL}}) just paid <strong>{{TOTAL_AMOUNT}} {{CURRENCY}}</strong> for the <strong>{{PLAN_NAME}} plan</strong>, renewed {{PAYMENT_FREQUENCY}}.<br /><br /><a href="{{PAYMENT_LINK}}" class="cta">View payment</a>',
