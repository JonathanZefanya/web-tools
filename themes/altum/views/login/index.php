...
//ZEFANYA:DEMO echo '<div class="card mb-4">';
//ZEFANYA:DEMO echo '<div class="card-body">';
//ZEFANYA:DEMO echo '<div class="h6">Demo</div>';
//ZEFANYA:DEMO echo '<div><small class="text-muted">📱 Some features are disabled as this is a demo version.</small></div>';
//ZEFANYA:DEMO echo '<div><small class="text-muted">🛠️ You can login as the admin with the prefilled credentials below.</small></div>';
//ZEFANYA:DEMO echo '<div><small class="text-muted">👨‍💻 You can also register your own account to test it as a normal user</small></div>';
//ZEFANYA:DEMO echo '</div>';
//ZEFANYA:DEMO echo '</div>';
//ZEFANYA:DEMO }
?>
