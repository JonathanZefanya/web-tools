...
<footer class="d-flex flex-column flex-lg-row justify-content-between">
    <div class="mb-3 mb-lg-0">
        ...
        <div>Powered by <img src="<?= ASSETS_FULL_URL . 'images/altumcode.png' ?>" class="icon-favicon" alt="Web Tools logo" /> <a href="https://xead.my.id/" target="_blank">Xeadesta</a>.</div>
    </div>
