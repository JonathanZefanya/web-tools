    ...
    <div class="table-responsive table-custom-container">
        <table class="table table-custom">
            ...
            <?php while($row = $result->fetch_object()): ?>
                <?php //ZEFANYA:DEMO if(DEMO) {$row->email = 'hidden@demo.com'; $row->name = 'hidden on demo';} ?>
            ...
            <div class="card-body py-2">
                <div>
                    <?php foreach($data->internal_notifications as $notification): ?>
                        <?php //ZEFANYA:DEMO if(DEMO) {$notification->title = $notification->description = 'hidden on demo';} ?>
        ...
        <div class="mb-5">
            ...
            <div class="table-responsive table-custom-container">
                <table class="table table-custom">
                    ...
                    <tbody>
                    <?php while($row = $result->fetch_object()): ?>
                        <?php //ZEFANYA:DEMO if(DEMO) {$row->email = $row->user_email = 'hidden@demo.com'; $row->user_name = $row->name = 'hidden on demo';} ?>
...
<div class="row justify-content-between">
    ...
    <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                ...
                <div class="mt-2"><span class="h6">jonathan.zefanya16@gmail.com</span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="mailto:jonathan.zefanya16@gmail.com" class="stretched-link" target="_blank">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-4 p-3 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body text-truncate">
                <small class="text-muted"><i class="fab fa-fw fa-sm fa-instagram mr-1"></i>Instagram</small>

                <div class="mt-2"><span class="h6">@xeadesta</span></div>
            </div>

            <div class="pr-4 d-flex flex-column justify-content-center">
                <a href="https://instagram.com/xeadesta" class="stretched-link" target="_blank">
                    <i class="fas fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
